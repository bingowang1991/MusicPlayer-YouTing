...
public class MusicDao extends AbstractDao<Music, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Parameter = new Property(9, Long.class, "parameter", false, "PARAMETER");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, Music entity) {
        ...
        Long parameter = entity.getParameter();
        if (parameter != null) {
            stmt.bindLong(10, parameter);
        }
    }
    ...
    public Music readEntity(Cursor cursor, int offset) {
        Music entity = new Music( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getLong(offset + 9) // parameter
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Music entity, int offset) {
        ...
        entity.setParameter(cursor.isNull(offset + 9) ? null : cursor.getLong(offset + 9));
     }
