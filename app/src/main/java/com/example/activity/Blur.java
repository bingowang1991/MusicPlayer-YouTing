...
public class Blur {
    ...
    public static Bitmap doBlur(Context context, Bitmap bkg, int radius) {
    ...
    private static Bitmap getResizedBitmap(Bitmap bm, int newHeight, int newWidth, boolean willDelete) {
